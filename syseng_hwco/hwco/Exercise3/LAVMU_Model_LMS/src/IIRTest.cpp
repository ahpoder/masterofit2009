...
int main( int argc, char **argv)
{
	...
	CreateTestFile(INPUT_FILE_F); // Create floating point test file

	// Architecture test file (Fixed)
	CreateTestFile(INPUT_FILE_LEFT, true); // Create fixed point test file
	CreateTestFile(INPUT_FILE_RIGHT, true); // Create fixed point test file
