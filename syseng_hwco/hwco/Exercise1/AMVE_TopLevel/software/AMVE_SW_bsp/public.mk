...
# The following are the "base" set of include paths for a HAL-based BSP.
...
#                               COMPILATION FLAGS
#------------------------------------------------------------------------------
# Default C pre-processor flags for a HAL-based BSP:
...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../AMVE_TopLevel.jdi

# Big-Endian operation. 
# setting BIG_ENDIAN is false


# Name of BSP library as provided to linker using the "-msys-lib" flag. 
...
# The SOPC Design Name 
# setting SOPC_NAME is CPU_System
SOPC_NAME := CPU_System
...
# The SOPC System ID 
# setting SOPC_SYSID is 679605662
SOPC_SYSID_FLAG += --id=679605662
ELF_PATCH_FLAG  += --id 679605662

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x1010a8
SOPC_SYSID_FLAG += --sidp=0x1010a8
ELF_PATCH_FLAG  += --sidp 0x1010a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1289848493
SOPC_SYSID_FLAG += --timestamp=1289848493
ELF_PATCH_FLAG  += --timestamp 1289848493
...
# compilerflags. The custom newlib build will be placed in the <bsp 
# root>/newlib directory, and will be used only for applications that utilize 
# this BSP. 
...
# is attempting to override HAL BSP sources.
