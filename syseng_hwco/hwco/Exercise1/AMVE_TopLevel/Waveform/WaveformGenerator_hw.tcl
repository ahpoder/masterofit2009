...
# | null 2010.11.15.19:52:43
# | 
# | 
# | C:/altera/91/quartus/AMVE_TopLevelNew/Waveform/WaveformGenerator.vhd
# | 
# |    ./SinusoidROM.qip 
# |    ./SinusoidROM.vhd syn, sim
# |    ./WaveformGenerator.vhd syn, sim
# | 
# +-----------------------------------
...
set_module_property TOP_LEVEL_HDL_FILE WaveformGenerator.vhd
set_module_property TOP_LEVEL_HDL_MODULE WaveformGenerator
...
# | files
# | 
add_file SinusoidROM.qip ""
add_file SinusoidROM.vhd {SYNTHESIS SIMULATION}
add_file WaveformGenerator.vhd {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
# +-----------------------------------
# | connection point AudioData
# | 
add_interface AudioData conduit end

set_interface_property AudioData ENABLED true

add_interface_port AudioData coe_AudioData_export export Output 24
# | 
# +-----------------------------------
